...
TEST(StringBufferTest, ConstructString)
{
    ...
    EXPECT_EQ(size_t(4), sbStringInstance.size());
...
TEST(StringBufferTest, ConstructStringSource)
{
    ...
    EXPECT_EQ(size_t(4), sbStringInstanceNull.size());
...
TEST(StringBufferTest, PlusEqualsCharacter)
{
    ...
    sb += 'a';
    EXPECT_EQ(size_t(1), sb.size());
    EXPECT_EQ('a', sb[0]);

    sb += 'b';
    EXPECT_EQ(size_t(2), sb.size());
    EXPECT_EQ('a', sb[0]);
    EXPECT_EQ('b', sb[1]);

    sb += 'c';
    EXPECT_EQ(size_t(3), sb.size());
    EXPECT_EQ('a', sb[0]);
    EXPECT_EQ('b', sb[1]);
    EXPECT_EQ('c', sb[2]);
}
...
{
    std::stringstream ss;
    EXPECT_EQ(size_t(0), getSizeDoubled(ss));
    EXPECT_EQ(size_t(0), getSizeDoubled((std::ostream &)ss));
    EXPECT_EQ(size_t(0), getSizeDoubled((std::istream &)ss));
    EXPECT_EQ(size_t(0), getSizeDoubled((std::iostream &)ss));

    StringBuffer sb;
    EXPECT_EQ(size_t(0), getSizeDoubled(sb));

    StringBufferPtr ssPtr(ss);
    EXPECT_EQ(size_t(0), getSizeDoubled(ssPtr));

    StringBufferPtr sbPtr(sb);
    EXPECT_EQ(size_t(0), getSizeDoubled(sbPtr));
}
...
TEST(StringBufferTest, StringBufferPtrIos)
{
    ...
    iosPtr->put('c');
    EXPECT_EQ(size_t(1), iosPtr->size());
    ...
    std::string str;
    *otherIosPtr >> str;
    EXPECT_EQ(size_t(4), otherIosPtr->size());
