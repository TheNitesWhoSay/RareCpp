...
TEST(AcceleratorsTest, ForPrimitive)
{
    ...
    Field<int, false, false> intField = { 0, "intValue", "int", 0, false, false, false };
    Field<int*, false, false> intPointerField = { 0, "intPointer", "int*", 0, false, false, false };
    Field<Obj, true, false> objField = { 0, "objValue", "Obj", 0, false, false, false };
...
TEST(AcceleratorsTest, ForObject)
{
    ...
    Field<Obj, true, false> objField = { 0, "objValue", "Obj", 0, false, false, true };
    Field<Obj*, true, false> objPointerField = { 0, "objPointerValue", "Obj*", 0, false, false, true };
    Field<int, false, false> intField = { 0, "intValue", "int", 0, false, false, true };
...
TEST(AcceleratorsTest, ForPrimitives)
{
    ...
    Field<int, false, false> intField = { 0, "intValue", "int", 0, false, false, false };
    Field<IntArray, false, false> intArrayField = { 0, "intArrayValue", "int[3]", arraySize, true, false, false };
    Field<IntArray*, false, false> intArrayPointerField = { 0, "intArrayPointerValue", "int[3]*", arraySize, true, false, false };
    Field<std::vector<int>, false, false> intVectorField = { 0, "intVectorValue", "std::vector<int>", 0, true, false, false };
    Field<std::vector<int>*, false, false> intVectorPointerField = { 0, "intVectorPointerValue", "std::vector<int>*", 0, true, false, false };
    Field<std::stack<int>, false, false> intStackField = { 0, "intStackValue", "std::stack<int>", 0, true, false, false };
    Field<std::stack<int>*, false, false> intStackPointerField = { 0, "intStackPointerValue", "std::stack<int>*", 0, true, false, false };
...
TEST(AcceleratorsTest, ForObjects)
{
    ...
    Field<Obj, true, false> objField = { 0, "objValue", "Obj", 0, false, false, true };
    Field<ObjArray, true, false> objArrayField = { 0, "objArrayValue", "Obj[3]", arraySize, true, false, true };
    Field<ObjArray*, true, false> objArrayPointerField = { 0, "objArrayPointerValue", "Obj[3]*", arraySize, true, false, true };
    Field<std::vector<Obj>, true, false> objVectorField = { 0, "objVectorValue", "std::vector<Obj>", 0, true, false, true };
    Field<std::vector<Obj>*, true, false> objVectorPointerField = { 0, "objVectorPointerValue", "std::vector<Obj>*", 0, true, false, true };
    Field<std::stack<Obj>, false, false> objStackField = { 0, "objStackValue", "std::stack<Obj>", 0, true, false, true };
    Field<std::stack<Obj>*, false, false> objStackPointerField = { 0, "objStackPointerValue", "std::stack<Obj>*", 0, true, false, true };
...
TEST(AcceleratorsTest, ForObjectsConst)
{
    ...
    Field<std::vector<Obj>, true, false> objVectorField = { 0, "objVectorValue", "std::vector<Obj>", 0, true, false, true };
    Field<std::vector<Obj>*, true, false> objVectorPointerField = { 0, "objVectorPointerValue", "std::vector<Obj>*", 0, true, false, true };
    Field<std::stack<Obj>, true, false> objStackField = { 0, "objStackValue", "std::stack<Obj>", 0, true, false, true };
    Field<std::stack<Obj>*, true, false> objStackPointerField = { 0, "objStackPointerValue", "std::stack<Obj>*", 0, true, false, true };
    ...
    timesVisited = 0;
    const auto & stackUnderlyingContainer = get_underlying_container(objStackValue);
...
TEST(AcceleratorsTest, ForPrimitivePairs)
{
    ...
    Field<int, false, false> intField = { 0, "intValue", "int", 0, false, false, false };
    Field<std::vector<std::pair<int, float>>, false, false> intToFloatVectorField = { 0, "intToFloatVectorValue", "std::vector<std::pair<int,float>>", 0, true, true, false };
    Field<std::vector<std::pair<int, float>>*, false, false> intToFloatVectorPointerField = { 0, "intToFloatVectorPointerValue", "std::vector<std::pair<int,float>>*", 0, true, true, false };
    Field<std::map<int, float>, false, false> intToFloatMapField = { 0, "intToFloatMapValue", "std::map<int,float>", 0, true, true, false };
    Field<std::map<int, float>*, false, false> intToFloatMapPointerField = { 0, "intToFloatMapPointerValue", "std::map<int,float>*", 0, true, true, false };
...
TEST(AcceleratorsTest, ForObjectPairs)
{
    ...
    Field<Obj, true, false> objField = { 0, "objValue", "Obj", 0, false, false, true };
    Field<std::vector<std::pair<int, Obj>>, true, false> objToFloatVectorField = { 0, "intToObjVectorValue", "std::vector<std::pair<int,Obj>>", 0, true, true, true };
    Field<std::vector<std::pair<int, Obj>>*, true, false> objToFloatVectorPointerField = { 0, "intToObjVectorPointerValue", "std::vector<std::pair<int,Obj>>", 0, true, true, true };
    Field<std::map<int, Obj>, true, false> objToFloatMapField = { 0, "intToObjMapValue", "std::map<int,Obj>", 0, true, true, true };
    Field<std::map<int, Obj>*, true, false> objToFloatMapPointerField = { 0, "intToObjMapPointerValue", "std::map<int,Obj>", 0, true, true, true };
...
TEST(AcceleratorsTest, ForPrimitivePointers)
{
    ...
    Field<int, false, false> intField = { 0, "intValue", "int", 0, false, false, false };
    Field<IntPointerArray, false, false> intPointerArrayField = { 0, "intPointerArrayValue", "int*[3]", arraySize, true, false, true };
    Field<IntPointerArray*, false, false> intPointerArrayPointerField = { 0, "intPointerArrayPointerValue", "int*[3]*", arraySize, true, false, true };
    Field<std::vector<int*>, false, false> intPointerVectorField = { 0, "intPointerVectorValue", "std::vector<int*>", 0, true, false, true };
    Field<std::vector<int*>*, false, false> intPointerVectorPointerField = { 0, "intPointerVectorPointerValue", "std::vector<int*>*", 0, true, false, true };
    Field<std::stack<int*>, false, false> intPointerStackField = { 0, "intPointerStackValue", "std::stack<int*>", 0, true, false, false };
    Field<std::stack<int*>*, false, false> intPointerStackPointerField = { 0, "intPointerStackPointerValue", "std::stack<int*>*", 0, true, false, false };
...
TEST(AcceleratorsTest, ForObjectPointers)
{
    ...
    Field<Obj, true, false> objField = { 0, "objValue", "Obj", 0, false, false, true };
    Field<ObjPointerArray, true, false> objPointerArrayField = { 0, "objPointerArrayValue", "Obj*[3]", arraySize, true, false, true };
    Field<ObjPointerArray*, true, false> objPointerArrayPointerField = { 0, "objPointerArrayPointerValue", "Obj*[3]*", arraySize, true, false, true };
    Field<std::vector<Obj*>, true, false> objPointerVectorField = { 0, "objPointerVectorValue", "std::vector<Obj*>", 0, true, false, true };
    Field<std::vector<Obj*>*, true, false> objPointerVectorPointerField = { 0, "objPointerVectorPointerValue", "std::vector<Obj*>", 0, true, false, true };
    Field<std::stack<Obj*>, false, false> objPointerStackField = { 0, "objPointerStackValue", "std::stack<Obj*>", 0, true, false, true };
    Field<std::stack<Obj*>*, false, false> objPointerStackPointerField = { 0, "objPointerStackPointerValue", "std::stack<Obj*>*", 0, true, false, true };
...
TEST(AcceleratorsTest, ForPrimitivePointerPairs)
{
    ...
    Field<int, false, false> intField = { 0, "intValue", "int", 0, false, false, false };
    Field<std::vector<std::pair<int, float*>>, false, false> intToFloatPointerVectorField = { 0, "intToFloatPointerVectorValue", "std::vector<std::pair<int,float*>>", 0, true, true, true };
    Field<std::vector<std::pair<int, float*>>*, false, false> intToFloatPointerVectorPointerField = { 0, "intToFloatPointerVectorPointerValue", "std::vector<std::pair<int,float*>>*", 0, true, true, true };
    Field<std::map<int, float*>, false, false> intToFloatPointerMapField = { 0, "intToFloatPointerMapValue", "std::map<int,float*>", 0, true, true, true };
    Field<std::map<int, float*>*, false, false> intToFloatPointerMapPointerField = { 0, "intToFloatPointerMapPointerValue", "std::map<int,float*>*", 0, true, true, true };
...
TEST(AcceleratorsTest, ForObjectPointerPairs)
{
    ...
    Field<Obj, true, false> objField = { 0, "objValue", "Obj", 0, false, false, false };
    Field<std::vector<std::pair<int, Obj*>>, true, false> objPointerToFloatVectorField = { 0, "intToObjPointerVectorValue", "std::vector<std::pair<int,Obj*>>", 0, true, true, true };
    Field<std::vector<std::pair<int, Obj*>>*, true, false> objPointerToFloatVectorPointerField = { 0, "intToObjPointerVectorPointerValue", "std::vector<std::pair<int,Obj*>>", 0, true, true, true };
    Field<std::map<int, Obj*>, true, false> objPointerToFloatMapField = { 0, "intToObjPointerMapValue", "std::map<int,Obj*>", 0, true, true, true };
    Field<std::map<int, Obj*>*, true, false> objPointerToFloatMapPointerField = { 0, "intToObjPointerMapPointerValue", "std::map<int,Obj*>*", 0, true, true, true };
